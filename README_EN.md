...
Here we take [ArchLinux](https://aur.archlinux.org/packages/mihomo) as example.
...
#### Set Up Systemd System Service
 > For those want to use system-wide service, you may also refer to [this](https://wiki.metacubex.one/startup/service/#systemd) 
