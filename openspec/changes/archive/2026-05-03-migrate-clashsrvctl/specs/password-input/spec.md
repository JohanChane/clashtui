...
The widget SHALL support standard text editing operations: character insertion at cursor, backspace (delete before cursor), Delete (delete at cursor), left/right cursor movement, Home, End.
