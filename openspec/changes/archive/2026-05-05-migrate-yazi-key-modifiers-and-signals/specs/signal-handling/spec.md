...
## Purpose
Graceful shutdown on OS signals (SIGQUIT, SIGHUP, SIGTERM), suspend/resume on SIGTSTP/SIGCONT, with SIGINT intentionally ignored — delegating Ctrl-C to the keyboard input system in raw mode.
