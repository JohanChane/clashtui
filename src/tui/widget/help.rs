...
pub fn render_help(f: &mut ratatui::Frame, tab: &impl TuiTab) {
    ...
    // Build global display bindings from the GLOBAL_DISPLAY_BINDINGS LazyLock.
    // Static import from app.rs to avoid circular dependency
    let global_shortcuts: &[DisplayBinding] = &crate::tui::app::GLOBAL_DISPLAY_BINDINGS;
