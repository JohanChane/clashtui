...
impl Proxies {
    ...
    fn handle_sort(&mut self, current: usize, sort_mode: super::Sort, state: &mut ListState) {
        match sort_mode {
            super::Sort::ByName => {
    ...
    pub fn dispatch_key(
        ...
        match key {
            ...
            super::Key::Sort(sort_mode) => self.handle_sort(current, sort_mode, state),
            super::Key::TestDelay => {
                let info = self
                    .tree
                    .node_at(current)
